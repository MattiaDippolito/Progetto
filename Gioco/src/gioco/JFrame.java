...
public class JFrame extends javax.swing.JFrame {
    ...
    public void paint(Graphics g) {
        ...
        offgc.setFont(f1);
        offgc.drawString(g1.PunteggioToString(), this.getWidth() / 2 - 75, this.getHeight() - 900);
        offgc.drawString(g2.PunteggioToString(), this.getWidth() / 2 + 75, this.getHeight() - 900);
